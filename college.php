			 ...
			 <div class="top-menu">
				 ...
				 <ul class="navig">
					 <li><a href="index.html">Home</a></li>
					  <li class="dropdown">
          <a class="dropdown-toggle active" data-toggle="dropdown" href="acade.php" id="dropdownMenu1">Academics <span class="caret"></span></a>
          <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
            <li><a href="academy.php">Academic Calander</a></li>
            <li><a href="sylubus.php">Syllabus</a></li>
            <li class="active"><a href="college.php">College Info</a></li>
          </ul>
        </li>
       <li class="dropdown">
...
<!----end-header---->
	...
	<div class="pages">
		...
		<h1 class="text-center" style="font-family:'Ubuntu-Medium';">COLLEGE </h1>
		...
		<div class="col-sm-8">
		         <div class="banner-grid w3-card-2">
				 <h3 style="text-align:center">College Info</h3></div>
