...
<!----end-header---->
	...
	<div class="pages">
		...
		<h1 class="text-center" style="font-family:'Ubuntu-Medium';">SYllABUS </h1>
...
?>
  ...
  <tr>
	 ...
	 <td style="text-align:center; color:#FF0000"><a href="../../university dashbord/uploads/<?=$r[2]?>.pdf">Download</a></td>
	 </tr>
	  <?php
      }
      ?>
