...
<!----end-header---->
	...
	<div class="pages">
		...
		<h1 class="text-center" style="font-family:'Ubuntu-Medium';">TIME TABLE </h1>
...
?>	
				...
				<a href="#"><img src="<?=$r[0]?>.jpg" width="100px" height="100px" class="img-responsive" /></a>
				<a href="<?=$r[0]?>_time.php" class="uppercase"><em><?=$r[0]?></em></a>
				</div></div></div>
                  </div>
				  <?php
				  }
