...
<li><a herf="logout.php" style="color:#FFFFFF">LogOut</a></li>
</ul>
</nav></div>
<div class="col-sm-6">
<div id="mem">
...
<tr>
	 ...
	 <td><?=$r[1]?></td>
	 <td><?=$r[2]?></td>
	 <td><a href="lidelete.php?id=<?=$r[1]?>"><img src="image.jpg" /></a></td>
</tr>
<?php
}
?>
