...
<div class="banner2">	  
	 <div class="header">
          ...
          <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
            ...
            <li class="active"><a href="sylubus.php">Syllabus</a></li>
...
<!----end-header---->
	<!--pages-starts-->
		<div class="pages">
		<div class="container-fluid" style="margin-bottom:200px; margin-top:40px">
		<div style="margin-bottom:40px">
		<h1 class="text-center" style="font-family:'Ubuntu-Medium';">EXAM'S CENTER </h1>
		...
		<div class="col-sm-8">
		         <div class="banner-grid w3-card-2">
				 <h3 style="text-align:center">Exam Center</h3></div>
...
?>
  ...
  <tr>
	 ...
	 <th style="text-align:center">Downlode</th>
	 </tr>
	  <?php
	 ...
	 <td style="text-align:center; color:#FF0000"><a href="../../university dashbord/examcenter/<?=$r[1]?><?=$r[3]?><?=$r[2]?>.pdf">Download</a></td>
	 </tr>
	  <?php
      }
      ?>
