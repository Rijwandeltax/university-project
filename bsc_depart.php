...
<!----end-header---->
	...
	<div class="pages">
		...
		<h1 class="text-center" style="font-family:'Ubuntu-Medium';">M.TEC. </h1>
		...
		<div class="col-sm-8">
		         <div class="banner-grid w3-card-2">
				 <h3 style="text-align:center">B.SC. Department</h3></div>
				<div class="w3-card-2 w3-white" style="margin-top:5px; padding:10px 10px 10px 10px"><p style="text-align:center; color:rgba(0, 0, 0, .5)"><i> The Master of Technology (BTech) degrees are engineering programs of two years in duration.</i></p>
				<p style="text-align:center; color:rgba(0, 0, 0, .5)"><i>the rough equivalent of a Master of Engineering degree is a professional master's degree that involves mostly coursework and a thesis or research paper in applied engineering</i></p>
				...
				<br><div class="row">
					<?php
            include("log.php");
            $rs=mysql_query("select * from sylebus where degree='m.tec'");
