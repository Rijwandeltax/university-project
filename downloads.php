...
<!----end-header---->
	...
	<div class="pages">
		...
		<h1 class="text-center" style="font-family:'Ubuntu-Medium';">Download Essential Form</h1>
		...
		<div class="col-sm-8">
		         <div class="banner-grid w3-card-2">
				 <h3 style="text-align:center">Provisional Degree Form</h3></div>
				<div class="w3-card-2 w3-white" style="margin-top:5px; padding:10px 10px 10px 10px">
				<p style="text-align:center; color:rgba(0, 0, 0, .5)"><i> The Bachelor of Technology (BTech) degrees are engineering .<a href="#" style="color:#009999">DOWNLOAD</a></i></p>
				</div><br>
				<br>
				<div class="banner-grid w3-card-2">
				 <h3 style="text-align:center">Migration Degree Form</h3></div>
				<div class="w3-card-2 w3-white" style="margin-top:5px; padding:10px 10px 10px 10px">
				<p style="text-align:center; color:rgba(0, 0, 0, .5)"><i> The Bachelor of Technology (BTech) degrees are engineering .<a href="#" style="color:#009999">DOWNLOAD</a></i></p>
				</div><br>
				<br>
				<div class="banner-grid w3-card-2">
				 <h3 style="text-align:center">Consolidated Mark Sheet Form</h3></div>
				<div class="w3-card-2 w3-white" style="margin-top:5px; padding:10px 10px 10px 10px">
				<p style="text-align:center; color:rgba(0, 0, 0, .5)"><i> The Bachelor of Technology (BTech) degrees are engineering .<a href="#" style="color:#009999">DOWNLOAD</a></i></p>
				</div><br>
				<br>
				<div class="banner-grid w3-card-2">
				 <h3 style="text-align:center">Correction In Name Form</h3></div>
				<div class="w3-card-2 w3-white" style="margin-top:5px; padding:10px 10px 10px 10px">
				<p style="text-align:center; color:rgba(0, 0, 0, .5)"><i> The Bachelor of Technology (BTech) degrees are engineering .<a href="#" style="color:#009999">DOWNLOAD</a></i></p>
				</div><br>
				<br></div></div></div></div>
