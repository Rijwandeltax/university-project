...
<!----end-header---->
	...
	<div class="pages">
		...
		<div class="col-sm-8">
		         <div class="banner-grid w3-card-2">
				 <h3 style="text-align:center">M.SC. Department</h3></div>
				<div class="w3-card-2 w3-white" style="margin-top:5px; padding:10px 10px 10px 10px">
				<p style="text-align:center; color:rgba(0, 0, 0, .5)"><i> The Master of Science (M.Sc.) is an academic degree for a post-graduate candidates or researchers.</i></p>
				<p style="text-align:center; color:rgba(0, 0, 0, .5)"><i>it usually takes from 2 years after passing The Bachelor of Science (B.Sc.) degree.</i></p>
