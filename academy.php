...
<div class="banner2">	  
	 <div class="header">
          ...
          <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
            <li class="active"><a href="academy.php">Academic Calander</a></li>
...
<!----end-header---->
	...
	<div class="pages">
		...
		<h1 class="text-center" style="font-family:'Ubuntu-Medium';">ACADEMICS </h1>
		...
		<div class="col-sm-8">
		         <div class="banner-grid w3-card-2">
				 <h3 style="text-align:center">CALANDER</h3></div>
...
?>
  ...
  <tr>
	 ...
	 <th style="text-align:center">Download Calander</th>
	 </tr>
	  <?php
	 ...
	 <td style="text-align:center; color:#FF0000"><a href="../../university dashbord/calnder/<?=$r[1]?><?=$r[2]?>.pdf">Download</a></td>
	 </tr>
	  <?php
      }
      ?>
